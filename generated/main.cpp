...
/** \mainpage RoboComp::episodic_improver
 *
 * \section intro_sec Introduction
 *
 * The episodic_improver component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/episodic_improver --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
#define PROGRAM_NAME    "episodic_improver"
#define SERVER_FULL_NAME   "RoboComp episodic_improver::episodic_improver"



class episodic_improver : public Ice::Application
{
public:
	episodic_improver (QString configFile, QString prfx, bool startup_check) { 
...
Ice::InitializationData episodic_improver::getInitializationDataIce(){
...
void episodic_improver::initialize()
{
...
int episodic_improver::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	episodic_improver app(configFile, prefix, startup_check_flag);
